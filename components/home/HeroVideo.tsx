...
export function HeroVideo() {
  return (
    <section className="relative isolate flex min-h-[100svh] flex-col justify-center overflow-hidden pb-20 pt-28 sm:pb-24 sm:pt-32 lg:min-h-[92vh] lg:pb-32 lg:pt-36">
      {/* Background */}
      ...
      >
        <div className="mx-auto max-w-5xl text-center lg:max-w-none">
          ...
          <img
            ...
            width={1024}
            height={63}
            className="mx-auto mb-6 h-auto w-[min(92vw,44rem)] sm:mb-8 lg:mb-10"
            fetchPriority="high"
          />

          {/* Headline – two lines as specified */}
          <h1 className="heading-font leading-[0.95] tracking-tight">
            <span className="block text-[clamp(2.25rem,8vw,5.5rem)] text-runway-white">
              BITCOIN.{" "}
              <span className="gradient-text">AI & ENERGY.</span>
            </span>
            <span className="mt-2 block text-[clamp(2.25rem,8vw,5.5rem)] sm:mt-3">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-[clamp(0.7rem,2.2vw,1.05rem)] font-medium uppercase tracking-[0.12em] text-un-blue sm:mt-10 sm:tracking-[0.18em] lg:mt-12 lg:text-base">
            UNGA + NYFW 2026 · September 10–19, 2026 · Times Square, NYC
          </p>

          {/* CTAs – spaced from headline and from next section */}
          <div className="mt-10 flex flex-col items-stretch justify-center gap-3 sm:mt-14 sm:flex-row sm:items-center sm:gap-4 lg:mt-16">
            <Link
              href={TICKETS_ANCHOR}
